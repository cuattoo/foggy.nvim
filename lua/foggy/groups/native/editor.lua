...
local groups = {
    ...
    MatchParen = { underline = true, bold = true, sp = C.white.bright }, -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
